...
x86_64-w64-mingw32-gcc-win32 -ggdb -O0 -Wall -Wno-parentheses -c standalone_scanf.c
x86_64-w64-mingw32-gcc-win32 -ggdb -O0 -Wall -Wno-parentheses -c wtfnicode.c
x86_64-w64-mingw32-gcc-win32 -ggdb -O0 -Wall -o scanf_demo.exe scanf_demo.c standalone_scanf.o wtfnicode.o -lm

gcc -ggdb -O0 -Wall -Wno-parentheses -c standalone_scanf.c
gcc -ggdb -O0 -Wall -Wno-parentheses -c wtfnicode.c
gcc -ggdb -O0 -Wall -o scanf_demo scanf_demo.c standalone_scanf.o wtfnicode.o -lm
